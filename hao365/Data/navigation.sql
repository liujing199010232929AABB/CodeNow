...
-- ----------------------------
INSERT INTO `nav_admin` VALUES ('1', 'mr', 'fdb390e945559e74475ed8c8bbb48ca5', '2015-01-28 00:00:00', '2016-06-30 12:55:19', '119.53.186.93');
...
CREATE TABLE `nav_high_level` (
  ...
  `sort` int(8) DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='高级分类表';
