                ...
                <table width="412" height="192" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <th colspan="2" align="left" valign="middle" scope="col">
                            <input name="d_name" type="text" id="d_name" size="20" value="<?php echo $obj->d_name ?>">
                        </th>
                    </tr>
                    <tr>
                        <td colspan="4" align="center" valign="middle">上级部门：
                            <select name="u_id">
                                ...
                                <?php
                                    ...
                                    $tmpresult = sqlsrv_query($conn,$tmpsql);
                                    while($tmprows = sqlsrv_fetch_array($tmpresult,SQLSRV_FETCH_ASSOC)){
                                        if($tmprows['id'] == $obj->top_depart){
                    ...
                    <tr>
                        ...
                        <td colspan="3"><textarea name="remark" cols="40" rows="5" id="remark"><?php echo $obj->remark ?></textarea></td>
                    </tr>
                    <tr>
