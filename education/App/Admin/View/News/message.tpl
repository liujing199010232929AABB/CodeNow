...
<!--<div class="wid1000 serachcondition">
搜索：   
<a href="#">不限属性</a>                                
<a href="#">不限字段</a>          
<a href="#">所有栏目 </a>        
...
<input type="hidden" name="rid" value="{$cfg.id}" />
	<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#dddddd">
		<tr>
          ...
          <td width="100" align="center" bgcolor="#eeeeee">用户名</td>
		  <td width="500" align="center" bgcolor="#eeeeee">信息标题</td>
          <td width="100" align="center" bgcolor="#eeeeee">悬赏</td>
          ...
          <td width="200" align="center" bgcolor="#eeeeee">发布时间</td>
        ...
        <foreach name="list" item="item" >
            <tr>
                ...
                <td align="center" bgcolor="#ffffff">{$item.score}&nbsp;积分 </td>
                ...
                <if condition="$cfg.is_pic gt 0"><td align="center" bgcolor="#ffffff">
                   <img src="__UPLOAD__/{$item.pic_path}" width="80" height="30" rel="__UPLOAD__/{$item.pic_path}" class="preview" />                </td></if>
                <td align="center" bgcolor="#ffffff">
                   ...
                   <if condition="$cfg.is_album gt 0">
                    ...
                    <a href="{:U('News/del','rid='.$item['rid'].'&id='.$item['id'])}" title="删除" onclick="javascript:if(confirm('确定删除此条目？')){return true;}else{return false;}"><img src="__IMG__/btns_05.jpg" class="opimg" /></a>
