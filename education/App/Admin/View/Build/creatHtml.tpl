...
function startCreat(mark , allmark){
	...
	$.ajax( {type: "get",url: "<php>echo U('Build/startCreat');</php>",cache: false,data:data ,dataType: "json",async:true
...
<div class="pcmobile">
<a href="{:U('Build/creatHtml')}" class="hover">PC 站</a>
<a href="{:U('Build/creatMobileHtml')}">手机站</a>
</div>
</if>
