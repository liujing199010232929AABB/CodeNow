	...
	<script type="text/javascript">
		...
		<div class="site_i_t_wrapper">
			<div class="w1002_wrapper">
				...
				<p class="t_f_crumbs">当前位置：<a target="_blank" href="<?php echo U('index/index');?>" title="网站首页">网站首页</a> &gt;
					<a target="_blank" href="<?php echo U('news/index_list',array('cid'=>1));?>" title="新闻中心">新闻中心</a> &gt;
					<?php echo ($classname); ?>
				</p>
			</div>
		</div>
		...
		<div class="s_i_d_box">
			<div class="s_i_title_box news_title_box">
				<h3><?php echo (fsubstr($dataInfo["title"],36)); ?></h3>
				<p>
					<span class="dt1">时间：<?php echo (date('Y-m-d',$dataInfo["addtime"])); ?></span>　　　　
					<span class="dt2">阅读：<?php echo ($clicks); ?>次</span>　　　　
					<span class="dt3">栏目：<?php echo ($classname); ?></span>
				</p>
			</div>
			<div class="s_i_contact_box">
				<p>联系电话：<span><?php echo ($webConfig["SiteTel"]["val"]); ?></span>　　　　　地址：<?php echo ($webConfig["SiteAddr"]["val"]); ?></p>
			</div>
			<div class="s_i_d_tbox news_d_box">
				<?php echo ($content); ?>
			</div>
            <div class="ra_l_box">
            	<p>【上一页】：<?php echo ($strU); ?></p>
            	<p>【下一页】：<?php echo ($strD); ?></p>
            </div>
		</div>
