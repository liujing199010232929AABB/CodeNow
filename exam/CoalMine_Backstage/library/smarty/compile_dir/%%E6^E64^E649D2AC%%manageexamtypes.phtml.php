<?php /* Smarty version 2.6.19, created on 2012-09-27 13:47:17
         compiled from manageexamtypes.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'manageexamtypes.phtml', 24, false),)), $this); ?>
...
$this->_sections['tID']['loop'] = is_array($_loop=$this->_tpl_vars['typeArr']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
      <DIV style="padding-left:6px;">
        <UL>
          <LI style="LINE-HEIGHT: 23px; WIDTH: 63%; padding-left:10px; FLOAT: left; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['typeArr'][$this->_sections['tID']['index']]['name']; ?>
</LI>
          <LI style="LINE-HEIGHT: 23px; WIDTH: 20%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_reg_objects['util'][0]->unHtml($this->_tpl_vars['typeArr'][$this->_sections['tID']['index']]['addtime']);?>
 </LI>
...
/manageexamtypes.php?f=edit&id=<?php echo $this->_tpl_vars['bigtypes'][$this->_sections['tID']['index']]['id']; ?>
&pid=<?php echo $this->_tpl_vars['bigtypes'][$this->_sections['tID']['index']]['pid']; ?>
...
/manageexamtypes.php?f=del&id=<?php echo $this->_tpl_vars['bigtypes'][$this->_sections['tID']['index']]['id']; ?>
&big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
';}">删除</a>
          </LI>
    ...
    <div class="right_con_form">
      <form name="form_manageexamtypes" method="post" action="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/manageexamtypes.php?big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
" >
            <div style="width:100%; text-align:left; padding-top:5px; padding-left:50px">
                所属分类（不填写为一级分类）：
                <select name="protype" id="protype" class="input1" >
                ...
                <br />
                <br />
                分类名称：<input type="text" name="chinese" size="30" class="input" value="<?php echo $this->_tpl_vars['examtype'][0]['chinese']; ?>
"/><br/><br/>
                英文名称：<input type="text" name="english" size="30" class="input" value="<?php echo $this->_tpl_vars['examtype'][0]['english']; ?>
"/><br/><br/>
                <input type="hidden" name="f" value="edit" />
                <input type="hidden" name="id" value="<?php echo $this->_tpl_vars['examtype'][0]['id']; ?>
" />
