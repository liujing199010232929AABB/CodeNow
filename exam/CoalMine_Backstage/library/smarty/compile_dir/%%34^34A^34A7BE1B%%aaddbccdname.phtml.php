<?php /* Smarty version 2.6.19, created on 2016-09-27 15:24:17
         compiled from aaddbccdname.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'aaddbccdname.phtml', 171, false),)), $this); ?>
    ...
    <DIV class="right_con_form">
      <form name="form_addbccdinfo" id="form_addbccdinfo" method="post" action="" enctype="multipart/form-data">
        ...
        <select name="second" id="second">
                    ...
                    <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['arraySecond'],'selected' => 0), $this);?>
