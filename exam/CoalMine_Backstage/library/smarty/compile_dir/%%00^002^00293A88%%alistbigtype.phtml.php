<?php /* Smarty version 2.6.19, created on 2016-09-27 10:37:19
         compiled from alistbigtype.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'alistbigtype.phtml', 24, false),)), $this); ?>
...
?>
      <DIV style="padding-left:6px;">
        <UL>
          ...
          <LI style="LINE-HEIGHT: 23px; WIDTH: 20%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['typeArr'][$this->_sections['tID']['index']]['addtime']; ?>
</LI>
...
/alistbigtype.php?f=edit&id=<?php echo $this->_tpl_vars['typeArr'][$this->_sections['tID']['index']]['id']; ?>
&pid=<?php echo $this->_tpl_vars['typeArr'][$this->_sections['tID']['index']]['parentid']; ?>
...
/alistbigtype.php?f=del&id=<?php echo $this->_tpl_vars['typeArr'][$this->_sections['tID']['index']]['id']; ?>
...
/alistbigtype.php?big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
" >
            <div style="width:100%; text-align:left; padding-top:5px; padding-left:50px">
                ...
                <br />
                <br />
                  大类名称：<input type="text" name="typename" size="30" class="input" value="<?php echo $this->_tpl_vars['bigtype'][0]['typename']; ?>
"/><br /><br />
...
<script language="javascript">
    ...
    document.getElementById("pro_class").value = 0;
    }
</script>