<?php /* Smarty version 2.6.19, created on 2016-09-27 16:50:29
         compiled from look_examinations.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'look_examinations.phtml', 248, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>模拟试卷——————<?php echo $this->_tpl_vars['bccdname'][0]['title']; ?>
</title>
...
题&nbsp;&nbsp; <a href="#" onClick="document.all.WebBrowser.Execwb(6,1)">模拟</a>&nbsp;&nbsp;</span>
    </td>
  </tr>
...
?>
  <tr>
    <td><span class="kt" style="background-color:#FFFFFF; border:1px dashed #FF6600; color:#333333;"> <span style="padding-top:4px; float:left;"> <?php 
              $i++;
              echo $i;
               ?>、<?php echo ((is_array($_tmp=$this->_tpl_vars['arrayFill'][$this->_sections['fil_id']['index']]['content'])) ? $this->_run_mod_handler('replace', true, $_tmp, '______', " <span style=' line-height:22px; padding-left:2px; padding-right:2px;'><input name='fill[]' type='text'  style='width:80px; height:18px; line-height:18px; border:1px solid #DDDDDD;' id='fill' size='10' maxlength='50'></span>") : smarty_modifier_replace($_tmp, '______', " <span style=' line-height:22px; padding-left:2px; padding-right:2px;'><input name='fill[]' type='text'  style='width:80px; height:18px; line-height:18px; border:1px solid #DDDDDD;' id='fill' size='10' maxlength='50'></span>")); ?>
 </span> </span></td>
  </tr>
    <?php endfor; endif; ?>
            <?php endif; ?>
...
" style="width:780px; padding-left:5px; float:left; line-height:25px; border:1px solid #AAAAAA; height:200px;" rows=""></textarea>
  ...
  <tr>
    <td><span style="width:913px; float:left; padding-left:13px; line-height:28px;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #FF0000; font-weight:bold;"> <?php 
              ...
              echo $n;
               ?>、 问答题（每题5分，共<?php echo $this->_tpl_vars['Answers']; ?>
题）</span> </td>
  </tr>
