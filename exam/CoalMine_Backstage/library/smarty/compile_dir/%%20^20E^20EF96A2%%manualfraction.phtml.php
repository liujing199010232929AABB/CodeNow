<?php /* Smarty version 2.6.19, created on 2012-09-29 16:08:51
         compiled from manualfraction.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'manualfraction.phtml', 14, false),array('modifier', 'escape', 'manualfraction.phtml', 45, false),)), $this); ?>
...
<div class="right_con">
 ...
 < <?php echo $_GET['small_type']; ?>
    ...
    <div class="right_con_bt" style=" height:53px; padding-top:4px; padding-bottom:4px; alignpadding-left:6px; ">员工成绩查询：
...
?>
        <DIV style="padding-left:6px;">
            <UL>
                ...
                <LI style="LINE-HEIGHT: 23px; WIDTH: 16%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['title']; ?>
 </LI>
...
?>
    <DIV style="padding-left:6px;">
        <UL>
            ...
            <LI style="LINE-HEIGHT: 23px; WIDTH: 16%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['title']; ?>
</LI>
...
<div class="sub_c">
    <form name="form_manualfraction" action="" method="post" onsubmit="return chkfraction(this)">
...
?>
            ...
            <li> <span style="width:100%; float:left; padding-left:10px; line-height:28px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 一、 单选题（选择一个正确答案字母）每题1分，共<?php echo $this->_tpl_vars['Radios']; ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;考生答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id']['index']]['3']; ?>
            ...
            <li> <span style="width:100%; float:left; padding-left:13px; line-height:28px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 二、 多选题（选择两个或两个以上正确答案字母）每题1分，共<?php echo $this->_tpl_vars['Checkboxs']; ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;考生答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id1']['index']]['3']; ?>
            ...
            <li> <span style="width:100%; float:left; padding-left:13px; line-height:28px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 三、 填空题（每空1分，共<?php echo $this->_tpl_vars['Fills']; ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;考生答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id2']['index']]['3']; ?>
            ...
            <li> <span style="width:100%; float:left; padding-left:13px; line-height:28px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 四、 判断题（正确的选正确；错误的选错误）每题5分，共<?php echo $this->_tpl_vars['Judgments']; ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;考生答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id3']['index']]['3']; ?>
...
?>
            ...
            <br><li> <span class="kt"> <span class="kt_t"> <?php 
            $i++;
            echo $i;
            echo "<a name=" .$i. "></a>";
            ...
            <?php echo $this->_tpl_vars['tb_exam'][$this->_sections['exam_id4']['index']]['content']; ?>
                ...
                <span class="kt_a"> 考生答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id4']['index']]['3']; ?>
 </span>
            ...
            <br><span class="kt_a"> 得分:<input type="text" name="ansfraction[]" class="input1" value="<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id4']['index']]['4']; ?>
"/>
<input type="hidden" name="befraction[]" class="input1" value="<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id4']['index']]['4']; ?>
"/>
            </li>
            <?php endif; ?>
            <?php endfor; endif; ?>
...
?>
            ...
            <?php echo $this->_tpl_vars['tb_exam'][$this->_sections['exam_id5']['index']]['content']; ?>
                ...
                <span class="kt_a"> 考生答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id5']['index']]['3']; ?>
 </span>
                ...
                <br><span class="kt_a"> 得分:<input type="text" name="disfraction[]" class="input1" value="<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id5']['index']]['4']; ?>
"/>
            <input type="hidden" name="befraction[]" class="input1" value="<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id5']['index']]['4']; ?>
"/>
            </li>
            <?php endif; ?>
            <?php endfor; endif; ?>
        ...
        <?php if ($this->_tpl_vars['hasbutton'] == 'T'): ?>
            <input type="hidden" value="<?php echo $this->_tpl_vars['aid']; ?>
" name="aid"/>
            <input type="hidden" value="<?php echo $this->_tpl_vars['Answers']; ?>
" name="answers"/>
...
<script language="javascript">
    ...
    function chkfraction(form){
        var obj = document.getElementsByName("ansfraction[]");
        var dobj = document.getElementsByName("disfraction[]");
        for(var i=0;i<obj.length;i++){
            ...
            if( obj[i].value<0 ||  obj[i].value>5){
                alert('请输入0-5之间的分数');
                obj[i].focus();
                return false;
            }
    ...
    for(var i=0;i<dobj.length;i++){
        ...
        if(isNaN(dobj[i].value)){
            alert('考生输入错误，请重新输入！');
            dobj[i].focus();
            return false;
        }
        if( dobj[i].value<0 ||  dobj[i].value>5){
            alert('请输入0-5之间的分数');
            dobj[i].focus();
            return false;
        }
