<?php /* Smarty version 2.6.19, created on 2016-09-27 13:24:23
         compiled from searchfraction.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'searchfraction.phtml', 69, false),array('modifier', 'escape', 'searchfraction.phtml', 103, false),)), $this); ?>
...
?>
            <DIV style="padding-left:6px;">
                <UL>
                    <LI style="LINE-HEIGHT: 20px; WIDTH: 19%;  FLOAT: left; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['admission']; ?>
</LI>
                    <LI style="LINE-HEIGHT: 20px; WIDTH: 16%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;overflow: hidden;"><?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['title']; ?>
 </LI>
                    <LI style="LINE-HEIGHT: 20px; WIDTH: 16%;  FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['name']; ?>
</LI>
                    <LI style="LINE-HEIGHT: 20px; WIDTH: 19%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['sub_time']; ?>
 </LI>
                    <LI style="LINE-HEIGHT: 20px; WIDTH: 13%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['fraction']; ?>
</LI>
                    <LI style="LINE-HEIGHT: 20px; WIDTH: 16%;  FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><a href="?edit=t&id=<?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['meid']; ?>
...
" class="a1">查阅试卷</a></LI>
<!--                    <LI style="LINE-HEIGHT: 20px; WIDTH: 16%;  FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><a href="#" onclick="updateFraction('notz','<?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['meid']; ?>
','<?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['examination_id']; ?>
','<?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['admission']; ?>
','<?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['title']; ?>
','<?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['name']; ?>
','<?php echo $this->_tpl_vars['bcjyzs']['data'][$this->_sections['id']['index']]['ID_number']; ?>
...
')" class="a1">调整</a></LI>-->
        ...
        <div id="tz" style="display: none">
            <form id="form2" name="form2" method="post" onsubmit="chknum(this)">
                ...
                <DIV style="padding-left:6px;">
                    <UL>
                        <LI id="admiss" style="LINE-HEIGHT: 20px; WIDTH: 16%;  FLOAT: left; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['admiss']; ?>
</LI>
                        <LI id="title" style="LINE-HEIGHT: 21px; WIDTH: 13%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;overflow: hidden;"><?php echo $this->_tpl_vars['title']; ?>
</LI>
                        <LI id="name" style="LINE-HEIGHT: 21px; WIDTH: 13%; padding-left:10px; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['name']; ?>
</LI>
                        <LI id="idnum" style="LINE-HEIGHT: 22px; WIDTH: 16%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['idnum']; ?>
 </LI>
                        <LI style="LINE-HEIGHT: 21px; WIDTH: 10%; padding-left:10px; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><input type="text" id="fraction" name="fraction" value="<?php echo $this->_tpl_vars['fraction']; ?>
...
?>
        <DIV style="padding-left:6px;">
            <UL>
                <LI style="LINE-HEIGHT: 20px; WIDTH: 16%; padding-left:10px; FLOAT: left;text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['admission']; ?>
</LI>
                <LI style="LINE-HEIGHT: 21px; WIDTH: 13%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;overflow: hidden;"><?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['title']; ?>
</LI>
                <LI style="LINE-HEIGHT: 21px; WIDTH: 13%; padding-left:10px; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['uname']; ?>
</LI>
                <LI style="LINE-HEIGHT: 22px; WIDTH: 16%; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['ID_number']; ?>
</LI>
                <LI style="LINE-HEIGHT: 21px; WIDTH: 10%; padding-left:10px; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['fraction']; ?>
</LI>
                <LI style="LINE-HEIGHT: 21px; WIDTH: 13%; padding-left:10px; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><a href="?edit=t&id=<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['meid']; ?>
&examination_id=<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['examination_id']; ?>
&lp=t&admiss=<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['admission']; ?>
&title=<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['title']; ?>
&name=<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['name']; ?>
&idnum=<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['ID_number']; ?>
&fraction=<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['fraction']; ?>
...
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
" class="a1">查阅试卷</a></LI>
                <LI style="LINE-HEIGHT: 21px; WIDTH: 16%; padding-left:10px; FLOAT: left; text-align:center; HEIGHT: 23px; BORDER-RIGHT: #21de26 1px solid; border-bottom:#21de26 1px solid;"><a href="#" onclick="updateFraction('notz','<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['meid']; ?>
','<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['examination_id']; ?>
','<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['admission']; ?>
','<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['title']; ?>
','<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['name']; ?>
','<?php echo $this->_tpl_vars['search_res'][$this->_sections['sea_id']['index']]['ID_number']; ?>
...
条</DIV>
    ...
    <br />
    <?php if ($this->_tpl_vars['search'] != 't'): ?>
        <div style="padding-left:6px; padding-top:6px;" id="notzpage"> <?php if ($this->_tpl_vars['bcjyzs']['data'] != false): ?>
...
/searchfraction.php?page=<?php echo $this->_tpl_vars['bcjyzs']['first']; ?>
&big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
" class="a1">首页</a>&nbsp;&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/searchfraction.php?page=<?php echo $this->_tpl_vars['bcjyzs']['previous']; ?>
&big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
" class="a1">上页</a>&nbsp;&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/searchfraction.php?page=<?php echo $this->_tpl_vars['bcjyzs']['next']; ?>
&big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
" class="a1">下页</a>&nbsp;&nbsp;<a href="<?php echo $this->_reg_objects['util'][0]->baseUrl();?>
/searchfraction.php?page=<?php echo $this->_tpl_vars['bcjyzs']['last']; ?>
&big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
...
/searchfraction.php?page=<?php echo $this->_tpl_vars['bcjyzs']['arrayNum'][$this->_sections['numId']['index']]; ?>
&big_type=<?php echo ((is_array($_tmp=$_GET['big_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
&small_type=<?php echo ((is_array($_tmp=$_GET['small_type'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'hex') : smarty_modifier_escape($_tmp, 'hex')); ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;您的答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id3']['index']]['3']; ?>
                    ...
                    <li> <span style="width:100%; float:left; padding-left:13px; line-height:28px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 五、 简答题（每题5分，共<?php echo $this->_tpl_vars['Answers']; ?>
...
?>
            ...
            <?php echo $this->_tpl_vars['tb_exam'][$this->_sections['exam_id4']['index']]['content']; ?>
                    ...
                    <li> <span style="width:100%; float:left; padding-left:13px; line-height:28px; background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 六、 论述题（每题5分，共<?php echo $this->_tpl_vars['Discourses']; ?>
