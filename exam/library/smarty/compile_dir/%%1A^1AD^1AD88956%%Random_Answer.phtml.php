<?php /* Smarty version 2.6.19, created on 2016-11-29 14:33:11
         compiled from Random_Answer.phtml */ ?>
...
<!--内容开始 -->
	<div id="sub">
    	<div id="sub_left">
        	<div class="left_fl">
            	<div class="left_fl_bt"><img src="images/381.jpg" alt="" /></div>
...
?>
   <?php  $i++;  ?>
    <li><a href="#" onClick="DoMenu('ChildMenu<?php  echo $i;  ?>')"><?php echo $this->_tpl_vars['typeNames'][$this->_sections['type_id']['index']]['typename']; ?>
</a>
...
?>
        <li><a href="Random_Answerpp.php?type_id=<?php echo $this->_tpl_vars['typeNames'][$this->_sections['type_id']['index']]['id']; ?>
&exam_id=<?php echo $this->_tpl_vars['examTypes'][$this->_sections['exam_id']['index']]['english']; ?>
" target="_blank"><?php echo $this->_tpl_vars['examTypes'][$this->_sections['exam_id']['index']]['chinese']; ?>
</a></li>
       <?php endfor; endif; ?>
      </ul>
    </li>
   <?php endfor; endif; ?>
        ...
        <form name="form_addbccdinfo" method="post" action="Random_Answers.php" >
      <div class="right">
        <div class="sub_c" style="padding-bottom:20px;">
          <div class="sub_c_bt" style="padding-top:32px; color:#000000; line-height:20px; font-size:48px; line-height:48px;font-weight:bold; text-align:center;"><?php echo $this->_tpl_vars['pro_class']; ?>
...
?>
              <li> <span class="kt"> <span style="font-size: 68px;line-height: 68px;">   <?php 
                $i++;
                echo $i;
                echo "<a name=" .$i. "></a>";
...
</span> </span> <span class="kt_a" style="padding-top: 55px;">
...
">
                ...
                <input type="radio" name="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
" style="margin-top:22px; margin-left:12px; float:left; display:inline;" value="A" id="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;line-height: 68px;">A</span> <span class="kt_a_1">
                <input type="radio" name="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
" style="margin-top:22px; margin-left:12px; float:left; display:inline;" value="B" id="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;line-height: 68px;">B</span> <span class="kt_a_1">
                <input type="radio" name="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
" style="margin-top:22px; margin-left:12px; float:left; display:inline;" value="C" id="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;line-height: 68px;">C</span> <span class="kt_a_1">
                <input type="radio" name="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
" style="margin-top:22px; margin-left:12px; float:left; display:inline;" value="D" id="radio<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['id']; ?>
">
...
</span> </span> <span class="kt_a" style="padding-top: 30px;">
...
[]" style=" margin-left:2px; margin-top:2px; float; display:inline;" value="A" id="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;">A</span> <span class="kt_a_1">
                <input type="checkbox" name="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
[]" style=" margin-left:2px; margin-top:2px; float; display:inline;" value="B" id="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;">B</span> <span class="kt_a_1">
                <input type="checkbox" name="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
[]" style=" margin-left:2px; margin-top:2px; float; display:inline;" value="C" id="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;">C</span> <span class="kt_a_1">
                <input type="checkbox" name="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
[]" style=" margin-left:2px; margin-top:2px; float; display:inline;" value="D" id="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;">D</span> <span class="kt_a_1">
                <input type="checkbox" name="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
[]" style=" margin-left:2px; margin-top:2px; float; display:inline;" value="E" id="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;">E</span> <span class="kt_a_1">
                <input type="checkbox" name="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
[]" style=" margin-left:2px; margin-top:2px; float; display:inline;" value="F" id="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
">
                </span><span class="kt_a_1" style="font-size: 68px;">F</span><span class="kt_a_1">
                  <input type="checkbox" name="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
[]" style=" margin-left:2px; margin-top:2px; float; display:inline;" value="G" id="checkbox<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['id']; ?>
">
                  </span><span class="kt_a_1" style="font-size: 68px;">G</span>
...
?>
            ...
            <?php echo $this->_reg_objects['util'][0]->mreplace($this->_tpl_vars['arrayFill'][$this->_sections['fil_id']['index']]['content'],$this->_tpl_vars['arrayFill'][$this->_sections['fil_id']['index']]['id']);?>
              ...
              <li> <span style="width:660px; float:left; padding-left:13px; font-size: 68px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 随机问答： 判断题 每题<?php echo $this->_tpl_vars['judgmentFraction']; ?>
分</span> </li>
...
" />
        ...
        <input type="image" name="submit" id="submit" src="images/gbda.jpg" style="margin-left: 250px;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="Random_Answer.php?type_id=<?php echo $this->_tpl_vars['type_id']; ?>
&exam_id=<?php echo $this->_tpl_vars['exam_id']; ?>
"><img src="images/xyt.jpg" /> </a>
      </div>
    	</form>
        <?php endif; ?>
