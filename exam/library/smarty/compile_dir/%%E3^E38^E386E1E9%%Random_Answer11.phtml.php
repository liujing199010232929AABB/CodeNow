<?php /* Smarty version 2.6.19, created on 2013-11-04 10:00:22
         compiled from Random_Answer11.phtml */ ?>
...
<body>
<!--内容开始 -->
	<div style="background-color: #fff;width: 759px;margin-left: auto;margin-right: auto;">

        <div id="sub_right">
        <?php if ($this->_tpl_vars['Random'] == 'T'): ?>
        <form name="form_addbccdinfo" method="post" action="Random_Answers11.php" >
      <div class="right">
...
?>
              <li> <span class="kt"> <span style="font-size: 68px;line-height: 68px;">
...
?>
              <li> <span class="kt"> <span class="kt_t" style="font-size: 68px;line-height: 68px;">
...
" />
        ...
        <a href="Random_Answer11.php?type_id=<?php echo $this->_tpl_vars['type_id']; ?>
