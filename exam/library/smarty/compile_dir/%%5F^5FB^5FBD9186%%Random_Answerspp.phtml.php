<?php /* Smarty version 2.6.19, created on 2016-10-09 19:36:21
         compiled from Random_Answerspp.phtml */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'calStyle', 'Random_Answerspp.phtml', 26, false),array('function', 'delbr', 'Random_Answerspp.phtml', 29, false),)), $this); ?>
	...
	<div style="background-color: #fff;width: 1259px;margin-left: auto;margin-right: auto;">
      ...
      <div class="right1">
        <div class="sub_c" style="padding-bottom:20px;">
          <div class="sub_c_bt1" style="padding-top:12px; color:#000000; line-height:48px; font-size:48px; font-weight:bold; text-align:center;"><?php echo $this->_tpl_vars['pro_class']; ?>
...
" style="width:1%;height: 1%"/>
                <li> <span style="width:1160px; float:left; padding-left:13px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; margin-top:40px;display:inline; border:1px solid #19b10a; font-weight:bold;font-size: 68px;">您的答案：<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['sub']; ?>
...
" style="display: none;"/>
                <li> <span style="width:1180px; float:left; padding-left:5px; margin-top: 30px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: 48px;line-height: 48px;">您的答案：<?php echo $this->_tpl_vars['arrayCheckbox'][$this->_sections['chk_id']['index']]['sub']; ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['arrayFill'][$this->_sections['fil_id']['index']]['right_error']; ?>
              ...
              <li> <span style="width:1180px; float:left; padding-left:5px; background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: 48px;"> 随机问答： 判断题 每题<?php echo $this->_tpl_vars['judgmentFraction']; ?>
分</span> </li>
...
" style="display: none;"/>
                 <li> <span style="width:1180px; float:left; padding-left:5px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: 68px;">您的答案：<?php echo $this->_tpl_vars['arrayJudgment'][$this->_sections['jud_id']['index']]['sub']; ?>
...
">
              ...
              <?php if ($this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['flag'] == 1): ?>
              <?php echo calStyle(array('str' => $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['sub'],'t' => 'text'), $this);?>

              <li> <span style="width:1180px; float:left; padding-left:5px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: <?php echo $this->_tpl_vars['size']; ?>
">您的答案：<?php echo $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['sub']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['right_error']; ?>

<?php if ($this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['resolve'] != ""): ?>
                 <br> <br>问题解析：<?php echo $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['resolve']; ?>

                  <?php endif; ?>
                </span></li>
              <?php else: ?><?php echo calStyle(array('str' => $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['sub'],'t' => 'text'), $this);?>

              <li> <span style="width:1180px; float:left; padding-left:5px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: <?php echo $this->_tpl_vars['size']; ?>
word-wrap: break-word;">您的答案：<?php echo $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['sub']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['right_error']; ?>


                </span></li><?php echo calStyle(array('str' => $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['answer'],'t' => 'text'), $this);?>

              <li> <span style="width:1180px; float:left; padding-left:5px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: <?php echo $this->_tpl_vars['size']; ?>
word-wrap: break-word;">正确答案：<?php echo $this->_tpl_vars['arrayExplain'][$this->_sections['exp_id']['index']]['answer']; ?>
...
line-height: <?php echo $this->_tpl_vars['size']; ?>
 word-wrap: break-word;">
                ...
                <?php if ($this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['flag'] == 1): ?><?php echo calStyle(array('str' => $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['sub'],'t' => 'text'), $this);?>

              <li> <span style="width:1180px; float:left; padding-left:5px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: <?php echo $this->_tpl_vars['size']; ?>
">您的答案：<?php echo $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['sub']; ?>
...
<?php if ($this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['resolve'] != ""): ?>
                 <br> <br>问题解析：<?php echo $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['resolve']; ?>

                  <?php endif; ?>
                </span></li>
                <?php else: ?><?php echo calStyle(array('str' => $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['sub'],'t' => 'text'), $this);?>

                <li> <span style="width:1180px; float:left; padding-left:5px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;word-wrap: break-word;font-size: <?php echo $this->_tpl_vars['size']; ?>
">您的答案：<?php echo $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['sub']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['right_error']; ?>


                </span></li><?php echo calStyle(array('str' => $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['answer'],'t' => 'text'), $this);?>

              <li> <span style="width:1180px; float:left; padding-left:5px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;word-wrap: break-word;font-size: <?php echo $this->_tpl_vars['size']; ?>
 ">正确答案：<?php echo $this->_tpl_vars['arrayAnswer'][$this->_sections['ans_id']['index']]['answer']; ?>
...
" />
          ...
          <div style="text-align: center;margin-bottom: 20px;padding-top: 50px;"> <a href="Random_Answerpp.php?type_id=<?php echo $this->_tpl_vars['type_id']; ?>
