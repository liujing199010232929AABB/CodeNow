<?php /* Smarty version 2.6.19, created on 2016-09-28 11:36:12
         compiled from search_exam.phtml */ ?>
<!--内容开始 -->
...
" width="145" height="174" alt="" /><?php else: ?><img src="CoalMine_Backstage/upfiles/userface/none.jpg" width="145" height="174" alt="" /><?php endif; ?></div>
          ...
          <div class="left_zl_a">
            <div class="left_zl_a_b">
              <ul>
                <li><span class="font9">考生姓名：</span><span class="font10"><?php echo $this->_tpl_vars['Users'][0]['name']; ?>
 </span></li>
                <li><span class="font9">准考证号：</span><span class="font10"><?php echo $this->_tpl_vars['Users'][0]['admission']; ?>
 </span></li>
...
?>
            <?php if ($this->_tpl_vars['examination'][$this->_sections['rad_id']['index']]['0'] == $this->_tpl_vars['radioproblems'][$this->_sections['exam_id']['index']]['id'] && $this->_tpl_vars['examination'][$this->_sections['rad_id']['index']]['1'] == $this->_tpl_vars['type_id']): ?>
...
?>
            <?php if ($this->_tpl_vars['examination'][$this->_sections['rad_id1']['index']]['0'] == $this->_tpl_vars['checkboxproblems'][$this->_sections['exam_id1']['index']]['id'] && $this->_tpl_vars['examination'][$this->_sections['rad_id1']['index']]['1'] == $this->_tpl_vars['type_id']): ?>
            <li> <span class="kt"> <span class="kt_t"> <?php 
              $i++;
              echo $i;
              echo "<a name=" .$i. "></a>";
...
?>
            <?php if ($this->_tpl_vars['examination'][$this->_sections['rad_id2']['index']]['0'] == $this->_tpl_vars['fillproblems'][$this->_sections['exam_id2']['index']]['id'] && $this->_tpl_vars['examination'][$this->_sections['rad_id2']['index']]['1'] == $this->_tpl_vars['type_id']): ?>
            <li> <span class="kt"> <span class="kt_t"> <?php 
              $i++;
              echo $i;
              echo "<a name=" .$i. "></a>";
...
?>
            <?php if ($this->_tpl_vars['examination'][$this->_sections['rad_id3']['index']]['0'] == $this->_tpl_vars['judgmentproblems'][$this->_sections['exam_id3']['index']]['id'] && $this->_tpl_vars['examination'][$this->_sections['rad_id3']['index']]['1'] == $this->_tpl_vars['type_id']): ?>
            <li> <span class="kt"> <span class="kt_t"> <?php 
              $i++;
              echo $i;
              echo "<a name=" .$i. "></a>";
...
<br>您的答案：<?php echo $this->_tpl_vars['examination'][$this->_sections['rad_id4']['index']]['3']; ?>
              ...
              <li> <span style="width:660px; float:left; padding-left:13px; line-height:28px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> 六、 简答题（每题5分，共<?php echo $this->_tpl_vars['Answers']; ?>
