<?php /* Smarty version 2.6.19, created on 2016-10-09 17:19:21
         compiled from exam.phtml */ ?>
<script type="text/javascript" xmlns="http://www.w3.org/1999/html" src="Scripts/jquery-1.4.2.js"></script>
...
function createCheckboxSign(inputobj){
    ...
    if($('#'+sign+'circlediv').length == 0){
        var objDiv = document.createElement('div');
        objDiv.id = sign +'circlediv';
        objDiv.className = 'checkboxcircle';
        $('#'+sign).append(objDiv);
    }
}
...
function createCheckboxEnd(inputobj){
    ...
    if($('#'+sign+'rectdiv').length == 0){
        var objDiv = document.createElement('div');
        objDiv.id = sign+'rectdiv';
        objDiv.className = 'checkboxrectangle';
        $('#'+sign).append(objDiv);
    }
    if($('#'+sign+'rectdiv').length != 0){
...
" />
                  ...
                  <li><span class="font9">考核类型：</span><span class="font10"><?php echo $this->_tpl_vars['typename']; ?>

                  <input type="hidden" name="pro_class" id="pro_class" value="<?php echo $_SESSION['proid']; ?>
" />
                  </span></li>
                </ul>
              </div>
    ...
    <div id="sub_right">
      <div class="right">
        <div class="sub_c" style="padding-bottom:20px;">
          <div class="sub_c_bt" style="padding-top:28px; color:#000000; line-height:10px; font-size:14px; font-weight:bold;"><span style="margin-left: 350px"><?php echo $this->_tpl_vars['examination'][0]['title']; ?>
</span><br>
              <span style="padding-left:25px;font-size:12px"><select onchange="changeFont()" id="selectfont"><option value="default">默认字号</option><option value="big">大字号</option></select><span style="padding-left: 500px;"><a href="#" onclick="javascript:window.location.reload();">刷新</a> &nbsp;<a href="#" onclick="if(confirm('确实要退出考试吗？'))window.close();">退出</a></span></span>
              <div style="padding-left: 605px;padding-top: 15px">总分：<?php echo $this->_tpl_vars['attr'][0]['totalscore']; ?>
分</div>
              <input type="hidden" name="title" id="title" value="<?php echo $this->_tpl_vars['examination'][0]['title']; ?>
" /><br />
            <span style=" color:#ff6101; font-weight:normal; padding-top:14px;padding-right:30px; font-size:12px; float:right;" id="sparetimes"><script type="text/javascript">
...
?>
              <li> <span class="kt" onmouseover="this.className='ktover'" onmouseout="this.className='kt'"> <span class="kt_t" id="ktchange_r">   <?php 
                $i++;
                echo $i;
                echo "<a name=" .$i. "></a>";
...
?>
              <li> <span class="kt" onmouseover="this.className='ktover'" onmouseout="this.className='kt'"> <span class="kt_t" id="ktchange_c"> <?php 
                $i++;
                echo $i;
                echo "<a name=" .$i. "></a>";
                 ?>、
...
H" onmousedown="createCheckboxSign(this)" onmouseup="createCheckboxEnd(this)">
...
?>
              <li> <span class="kt" onmouseover="this.className='ktover'" onmouseout="this.className='kt'"> <span style="padding-top:4px; float:left;"><span class="kt_t" id="ktchange_f"> <?php 
...
?>
              <li> <span class="kt" onmouseover="this.className='ktover'" onmouseout="this.className='kt'"> <span class="kt_t" id="ktchange_j"> <?php 
...
" onmousedown="createSign(this)" onmouseup="createEnd(this)">
                </span><span class="kt_a_1" style="width:55px;font-size: 22px;">正确</span><span class="kt_a_1" id='judgment<?php echo $this->_tpl_vars['arrayJudgment'][$this->_sections['jud_id']['index']]['id']; ?>
错误'>
                <input type="radio" name="judgment<?php echo $this->_tpl_vars['arrayJudgment'][$this->_sections['jud_id']['index']]['id']; ?>
...
" onmousedown="createSign(this)" onmouseup="createEnd(this)">
                </span><span class="kt_a_1" style="width:55px;font-size: 22px;">错误</span></span></li>
              <?php endfor; endif; ?>
              <?php endif; ?>
              </p>
              <p> </p>
              ...
              <li> <span style="width:660px; float:left; padding-left:13px; line-height:28px;  background-color:#ffffff;  color:#000000; margin-bottom:5px; display:inline; border:1px solid #19b10a; font-weight:bold;"> <?php 
                ...
                echo $n;
                 ?>、 名词解释题（每题<?php echo $this->_tpl_vars['explainFraction']; ?>
...
<script type="text/javascript">
    <?php echo '
    function changeFont(){
        obj = document.getElementById("selectfont");
        $("span[id^=\'ktchange_\']").each(
            function(){
                if(obj.value=="default"){
                    if($(this).hasClass("kt_t1")){
                        $(this).removeClass("kt_t1");
                    }
                    $(this).addClass("kt_t");
                }else{
                    if($(this).hasClass("kt_t")){
                        $(this).removeClass("kt_t");
                    }
                    $(this).addClass("kt_t1");
                }
            }
