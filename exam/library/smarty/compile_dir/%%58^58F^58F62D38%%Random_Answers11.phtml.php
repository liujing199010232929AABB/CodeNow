<?php /* Smarty version 2.6.19, created on 2013-11-04 10:01:20
         compiled from Random_Answers11.phtml */ ?>
...
<br>您的答案：<?php echo $this->_tpl_vars['arrayRadio'][$this->_sections['rad_id']['index']]['sub']; ?>
...
">
                 ...
                 <li> <span style="width:660px; float:left; padding-left:13px;  background-color:#ffffff;  color:#000000; margin-bottom:5px;margin-top: 32px; display:inline; border:1px solid #19b10a; font-weight:bold;font-size: 48px;">正确答案：<?php echo $this->_tpl_vars['arrayJudgment'][$this->_sections['jud_id']['index']]['answer']; ?>
...
" />
        ...
        <div style="text-align: center;margin-bottom: 20px;"> <a href="Random_Answer11.php?type_id=<?php echo $this->_tpl_vars['type_id']; ?>
