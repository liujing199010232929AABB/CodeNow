 		...
 		<form id="reg" name="reg" method="post" enctype="multipart/form-data" action="register_chk.php">
 			<tr>
  			...
  			<tr>
   			  ...
   			  <td align="left" valign="middle" scope="col"><input type="text" name="name" id="name" class="usual" onmouseover="this.style.backgroundColor='#deebef'" onmouseout="this.style.backgroundColor=''"/><span class="STYLE1"> *</span>[<input type="button" name="chk_name" id="chk_name" value="检测用户名" onclick="return chkname()"/>]</td>
    		</tr>
    		<tr>
