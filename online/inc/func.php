...
?>
<tr>
	<td width="131" height="30"><div align="right" ></div><div align="right">名称：</div></td>
    <td width="300" height="30"><input name="names" type="text" id="names" size="30">* </td>
</tr>
<tr>
    <td height="30"><div align="right">等级：</div></td>
    <td height="30">
...
<tr>
	<td height="30"><div align="right">发行商：</div></td>
    <td height="30">
      <input name="publisher" type="text"  id="publisher" size="30">
      *</td>
</tr>
<tr>
    <td height="30"><div align="right">主要演员：</div></td>
    <td height="30">
      <input name="actor" type="text"  id="actor" size="30">
      *</td>
</tr>
<tr>
    <td height="30"><div align="right">导演：</div></td>
    <td height="30">
      <input name="director" type="text"  id="director" size="30">
      *</td>
</tr>
<tr>
    <td height="30"><div align="right">制片人：</div></td>
    <td height="30">
      <input name="marker" type="text"  id="marker" size="30">
      *</td>
</tr>
<tr>
    <td height="30"><div align="right">语言：</div></td>
    <td height="30">
<div align="left" >
...
<tr>
    <td height="30"><div align="right">二级分类：</div></td>
    <td height="30">
  ...
  <tr>
    <td height="30"><div align="right">一级分类：</div></td>
    <td height="30">
...
?>
  ...
  <tr>
    <td height="30"><div align="right">发行国家：</div></td>
    <td height="30">
      <input name="from" type="text"  id="from" size="30">
      *</td>
  </tr>
  <tr>
    <td height="30"><div align="right">发行时间：</div></td>
    <td height="30">
      <input name="publishtime" type="text"  id="publishtime" size="30">
      *</td>
  </tr>
  <tr>
    <td height="30"><div align="right">新品：</div></td>
    <td height="30">
  ...
  <tr>
    <td height="60"><div align="right">简要介绍：</div></td>
    <td height="60">
  ...
  <tr>
    <td height="30"><div align="right">影片详情：</div></td>
    <td height="30">
...
<tr>
            ...
            * </td>
                        ...
                        <tr>
                          <td height="30"><div align="right">演唱者：</div></td>
                          <td height="30">
                            <input name="actor" type="text"  id="grade" size="30">
            *</td>
                        </tr>
                        <tr>
                          <td height="30"><div align="right" >演唱者类型：</div></td>
                          <td height="30">
                            <div align="left">
...
乐队                    *</div> 
                        ...
                        <tr>
                          <td height="30"><div align="right">作词：</div></td>
                          <td height="30">
                            <input name="ci" type="text" >
*                          </td>
                        </tr>
                        <tr>
                          <td height="30"><div align="right">作曲：</div></td>
                          <td height="30">
...
*</td>
            ...
            *</td>
						...
						<tr>
                          <td height="30"><div align="right">简要介绍：</div></td>
                          <td height="30">
                            <textarea name="remark" cols="35" rows="3"  id="remark"></textarea>
